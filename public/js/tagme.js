	...
	$.fn.TagMe = function(options){
			...
			defaults = {
				...
				tagpanelElement: '<div class="tm-tagpanel">'+
										 '<form id="tm-tagpanel-form">'+
											 ...
											 '<input name="itemQty" value="Quantity">'+
		...
		this.click(function(e) {
			...
			if(tagBox == null && tagpanel == null)
			{
				...
				tagpanel.find(".cancel").click(function(e)
				{
					e.stopPropagation();
					cancelTag();
				});
		...
		function initEditTagPanel(element,data){
			...
			tagpanel.find("input[name=itemQty]").val(data.tagData.itemQty);
